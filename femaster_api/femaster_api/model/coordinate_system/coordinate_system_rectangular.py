"""Rectangular coordinate system defined by basis directions.

The first basis direction is required; second and third directions may be
omitted when FEMaster can reconstruct them.  Every supplied vector is validated
to contain exactly three numerical components before it reaches export.
"""
...
class RectangularCoordinateSystem(CoordinateSystem):
    """Named rectangular coordinate system."""
