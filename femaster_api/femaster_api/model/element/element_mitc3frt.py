"""Concrete ``MITC3FRT`` element definition.

Three-node finite-rotation MITC shell element.  The class contains only the topology information that
...
class MITC3FRT(Element):
    """Three-node finite-rotation MITC shell element."""
