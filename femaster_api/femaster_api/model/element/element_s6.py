"""Concrete ``S6`` element definition.

Six-node quadratic triangular shell element.  The class contains only the topology information that
...
class S6(Element):
    """Six-node quadratic triangular shell element."""
