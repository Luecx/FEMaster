"""Concrete ``MITC4FRT`` element definition.

Four-node finite-rotation MITC shell element.  The class contains only the topology information that
...
class MITC4FRT(Element):
    """Four-node finite-rotation MITC shell element."""
