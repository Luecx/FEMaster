"""Concrete ``C3D4`` element definition.

Four-node linear tetrahedral solid element.  The class contains only the topology information that
...
class C3D4(Element):
    """Four-node linear tetrahedral solid element."""
