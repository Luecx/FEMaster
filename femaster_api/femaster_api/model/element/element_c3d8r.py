"""Concrete ``C3D8R`` element definition.

Eight-node reduced-integration hexahedral solid element.  The class contains only the topology information that
...
class C3D8R(Element):
    """Eight-node reduced-integration hexahedral solid element."""
