"""Concrete ``C3D20`` element definition.

Twenty-node quadratic hexahedral solid element.  The class contains only the topology information that
...
class C3D20(Element):
    """Twenty-node quadratic hexahedral solid element."""
