/******************************************************************************
* @file elasticity.cpp
* @brief Implements the Elasticity base class for material elasticity properties.
*
* This file contains the implementation of transformation utilities and
* dimension-specific stiffness matrix retrieval for the Elasticity class.
*
* @see elasticity.h
******************************************************************************/
...
// Retrieves the stiffness matrix for the given dimension
template <Dim D>
...
// Computes the transformation matrix for 3D stiffness
...
// Computes the derivative of the transformation matrix
...
// Computes the transformed stiffness matrix for a given rotation
template <Dim D>
...
// Computes the derivative of the transformed stiffness matrix
template <Dim D>
StaticMatrix<(D == 3 ? 6 : 3), (D == 3 ? 6 : 3)> Elasticity::get_transformed_derivative(StaticMatrix<D, D> R, StaticMatrix<D, D> R_der) {
    static_assert(D == 3, "Only 3D transformation is implemented.");
    StaticMatrix<6, 6> T_eps = transformation(R);
