...
bool IsotropicElasticity::supports_axial_linearized() const { return true; }
bool IsotropicElasticity::supports_axial_green_lagrange() const { return true; }
bool IsotropicElasticity::supports_volume_linearized() const { return true; }
bool IsotropicElasticity::supports_volume_green_lagrange() const { return true; }
bool IsotropicElasticity::supports_shell_integration_linearized() const { return true; }
bool IsotropicElasticity::supports_shell_integration_green_lagrange() const { return true; }
