...
Eigen::Matrix<Precision, 3, 1> Line3A::shape_function(Precision r) const {
...
Eigen::Matrix<Precision, 3, 1> Line3A::shape_derivative(Precision r) const {
...
Eigen::Matrix<Precision, 3, 1> Line3A::shape_second_derivative(Precision /*r*/) const {
