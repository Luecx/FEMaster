 ...
 * @brief Declares concentrated point-element mass, inertia and ground stiffness properties.
 *
 ...
 * translational/rotational stiffness against ground.
 *
 ...
 * @brief Concentrated mass, rotary inertia and ground-spring property.
 *
 ...
 * per rotational axis, and the two spring vectors act independently against
