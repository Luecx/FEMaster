 ...
 * @brief Implements core `ConstraintTransformer` assembly and mapping methods.
 *
 * This unit contains constructor/setup logic plus common transformation
 * operations that are shared by NULLSPACE and LAGRANGE modes.
 *
