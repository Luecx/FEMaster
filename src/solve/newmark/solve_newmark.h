 ...
 *
 * Device/Method hooks:
 *  - SolverDevice::CPU supported. GPU path is explicit and currently reports an error.
...
struct NewmarkOpts {
    ...
    // Solver stack control (GPU is dispatched separately; INDIRECT currently uses DIRECT in the CPU path)
