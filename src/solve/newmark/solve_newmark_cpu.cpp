/**
 * @file solve_newmark_cpu.cpp
 * @brief CPU implementation of implicit Newmark-β with single factorization.
 */
...
NewmarkResult
newmark_linear_cpu(const SparseMatrix& M,
                   const SparseMatrix& C,
                   const SparseMatrix& K,
                   const NewmarkIC& ic,
                   ...
                   ForceFn f_of_t)
{
    ...
    // Method hook: INDIRECT uses the same direct factorization in this implementation.
    (void)opts.method;
