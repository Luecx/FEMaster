 ...
 *
 * @see model::Model::add_nodes_to_part_set
 * @see model::Model::add_nodes_to_assembly_set
 ...
 */
void register_nset(dsl::Registry& registry, model::Model& model) {
