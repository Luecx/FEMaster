...
inline void register_surface_count(fem::io::dsl::Registry& registry, SurfaceCountSink sink) {
    registry.command("SURFACE", [sink = std::move(sink)](fem::io::dsl::Command& command) {
