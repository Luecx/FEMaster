...
// ORDER_SUPER_LINEAR
constexpr Point domain_iso_wedge_points_super_linear[] = {
...
constexpr Point domain_iso_wedge_points_super_quadratic[] = {
    // Lower z = -csqrt(0.6)
...
REGISTER_SCHEME(DOMAIN_ISO_WEDGE, ORDER_SUPER_LINEAR    , domain_iso_wedge_points_super_linear);
REGISTER_SCHEME(DOMAIN_ISO_WEDGE, ORDER_SUPER_QUADRATIC, domain_iso_wedge_points_super_quadratic);
