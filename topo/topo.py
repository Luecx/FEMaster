...
model = model.Model(width=160, height=40, length=40)
corners, edge_mids, face_mids, volume_mid = model.get_special_node_ids()

model.set_support(corners[0], 0, 0, 0)
model.set_support(corners[1], None, 0, 0)
model.set_support(corners[2], None, None, 0)
model.set_support(corners[3], None, None, 0)

model.set_force(face_mids[1], 0, 0, -100)
