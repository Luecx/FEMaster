...
class Optimiser:
    ...
    def set_solver(self, path=None, method='indirect', device='gpu'):
    ...
    def _run(self, iteration):
        ...
        with open(log_path, 'w') as log_file:
            result = subprocess.run([self.solver, model_path], stdout=log_file, stderr=log_file)
...
# opt = Optimiser(input_deck="../../test_extruded_3.inp",
#                 desi_set="EALL",
#                 load_cols=["LOAD"],
#                 support_cols=["SUPP"],
#                 output_folder="./test/")
#
# opt.set_solver(path="../../bin/FEMaster_gpu.exe", method="indirect", device="gpu")
# opt.set_exponent(2)
# opt.add_planar_symmetry('xy', 5)
# opt.set_target_density(0.2)
# opt.set_filter(0.1)
# opt.set_symmetry_radius(0.2)
