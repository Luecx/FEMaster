...
named coordinate system. Without that keyword, the Abaqus reader honors
any knot-specific \cmd{TRANSFORM} assignment.
...
remain reusable by referring to them from \cmd{LOADS} in a native load case.
