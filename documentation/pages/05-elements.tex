...
\val{MITC8} combines the quadratic eight-node serendipity topology of \val{S8} with tied transverse-shear interpolation. The two generalized shear components are evaluated at dedicated tying locations, interpolated in the natural element coordinates, and transformed back into the local shell coordinates. Their order is \(\gamma_{13},\gamma_{23}\), energetically conjugate to \(Q_{13},Q_{23}\).
