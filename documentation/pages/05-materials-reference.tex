...
\cmd{THERMALEXPANSION} is the legacy spelling of \cmd{EXPANSION}. Both FEMaster and Abaqus input readers accept it with exactly the same syntax and constant isotropic thermal-expansion behavior. Use \cmd{EXPANSION} for new decks.
...
\begin{abaqusdeck}
*MATERIAL, NAME=ALUMINIUM
*THERMALEXPANSION, TYPE=ISOTROPIC
2.30e-5
\end{abaqusdeck}
\end{dialectexamples}
