...
Whenever a new input keyword or element formulation is added, this index should be updated together with its detailed thematic documentation and, where useful, a complete example. This keeps the manual aligned with the syntax users can actually run.
