...
\cmd{CONSTRAINTMETHOD} & Select Nullspace or Lagrange constraint handling for static loadcases that support it. \\
\cmd{NONLINEAR} & Configure nonlinear static increments, iterations, residual tolerance, and zero-row regularization. \\
