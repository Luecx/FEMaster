...
The data following \cmd{SHELLSECTION} with \key{TYPE=ABD} contain the \(6\times6\) ABD matrix in row-major order followed by the four entries of \(S\), also in row-major order. The example uses a symmetric uncoupled laminate, but the parser accepts all 36 ABD entries independently.
...
*SHELLSECTION, ELSET=PANEL, TYPE=ABD, THICKNESS=1.0
